 ...
 <!--NavigationBar-->
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link" href="logout.php">Se déconnecter</a>
            ...
            <div class="main-container">
                <p><?php echo "<a href=modifPho.php?matricule=$matricule><i>(cliquez pour modifier votre photo)</i></a>"?></p>
    ...
    echo $filiere;
                ...
                <p><?php echo "<a href=modif_exe.php?matricule=$matricule>Modifier mes informations:<i>(cliquez pour modifier)</i></a>"?></p>
                <?php echo "<p>Email:  $email</p>" ?> 
                <div class="image-container1">
                    <hr>
                <p><?php echo "<a href=modifCIN.php?matricule=$matricule>Copie de la CIN:<i>(cliquez pour modifier)</i></a>"?></p>
                    <?php echo "<img src= '$cin' style='width: 100%'>"?>
            </div>
                <div class="image-container1">
                    <hr>
                <p><?php echo "<a href=modifAttes.php?matricule=$matricule>Attestation de réussite (CNC, DEUG ou Licence):<i>(cliquez pour modifier)</i></a>"?></p>

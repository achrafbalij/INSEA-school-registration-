                ...
                $sql = "SELECT * FROM email";
					...
					if (mysqli_num_rows($result) > 0) {
    					...
    					while($row = mysqli_fetch_assoc($result)) {
        					echo "<tr><td> " .$row["Date"]."</a>"."</td><td>" . 
							$row["Nom"]."</td><td colspan='1'><a href=_sendpage1.php?email=".$row["Email"].">".$row["Email"]."</a>" . "</td><td>".$row["Sujet"] . "</td><td colspan='3'>".$row["Message"]."</td><td><a href=\"supp_dema.php?id=".
							$row["id"]."\" onclick=\"return confirm('Vous voulez vraiment supprimer ce message')\">Supprimer</a></td></tr>";
    					}
